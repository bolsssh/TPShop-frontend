...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ProductE', 'i-i-s-shop-product', {
    productCode: attr('товар', {index: 0}),
  ...
  modelClass.defineProjection('ProductL', 'i-i-s-shop-product', {
    productCode: attr('Товар', {index: 0}),
    name: attr('Наименование', {index: 1}),
    measure: attr('Единица измерения', {index: 1}),
    description: attr('Описание', {index: 2}),
    price: attr('Цена за ед.', {index: 3}),
    weight: attr('Вес в кг', {index: 4})
  });
};
